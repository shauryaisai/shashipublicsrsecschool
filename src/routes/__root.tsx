        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-school-gold rounded-full flex items-center justify-center font-bold text-school-navy">SP</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-90">
              ...
              <li><Link to="/gallery" className="hover:text-school-gold transition-colors">Gallery</Link></li>
